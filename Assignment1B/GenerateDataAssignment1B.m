...
%  4) mission.m
%
%  Enter your student numbers into line 19.
...
st = 10528873; % insert student number here

%  Initialise the assignment variables and save them into Data1B.mat.
initialise1B(st); % do not modify this line.

%  The initialise1B.p function will automatically save the variables.
%  A message will be displayed on the Command Window upon successful 
%  execution of the code.
%
%  The mission.m file will load and work with the Data1B.mat file directly.
