...
%% Question 1: Plotting the Received
...
%% Question 3 Classifying Signals
...
title('Hand Calculation vs Received Signal')
xlabel('Time (s)')
ylabel('Amplitude')
legend('Hand Calculation', 'Received Signal')
